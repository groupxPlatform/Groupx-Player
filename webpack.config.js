...
var frontendConfig = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      title: 'Skele',
      filename: 'index.html',
      template: 'public/frontend/index.template.html',
      inject: true
    })
  ],
  ...
  module: {
    loaders: [
      ...
      {
        test: /\.scss$/,
        include: path.join(__dirname, 'public', 'frontend', 'scss'),
...
var serverConfig = {
  entry: './public/server/express_socket.js',
  output: {
